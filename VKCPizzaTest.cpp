...
{
	public:
    char name[20],adrs[20],email_id[30],itm[20],itm_typ[20],mob[15],size[20],crust[20],payment[20];
...
void display_order(char* mob_no)
{
	...
	while(file.read((char*)&phut,sizeof(phut)))
	{
		if(strcmp(phut.get_mobile_no(),mob_no)==0)
		{
			system("cls");
			phut.display_customer_info();
			found=true;
 ...
 void cancel_order()
{
	char mob_no[15];
	system("cls");
	cout<<endl<<endl<<"Please Enter The Mobile_No. #: ";
	cin>>mob_no;
...
int main()
{
	...
	switch(p)
	{
		...
		case 2:
		    ...
		    goto lbl;
		case 3:
			cout<<"Enter the Mobile_NO of the customer to see Order\n";
			cin>>mob_no;
